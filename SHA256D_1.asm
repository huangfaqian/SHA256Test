...
CONST_SEG SEGMENT ALIGN(32) 'CONST'
; SHA256 constants
...
SHUF_ZZZZ10ZZ   DD 80808080H, 80808080H, 03020100H, 07060504H, 80808080H, 80808080H, 80808080H, 80808080H
SHUF_ZZZZZZ32   DD 0B0A0908H, 0F0E0D0CH, 80808080H, 80808080H, 80808080H, 80808080H, 80808080H, 80808080H
SHUF_54ZZZZZZ   DD 80808080H, 80808080H, 80808080H, 80808080H, 80808080H, 80808080H, 03020100H, 07060504H
SHUF_ZZZZ0ZZZ   DD 80808080H, 80808080H, 80808080H, 03020100H, 80808080H, 80808080H, 80808080H, 80808080H
...
;DB 64H, 67H, 90H
    ...
    VPXOR   Y0, Y0, Y2                      ; Y0 = ([W8, W7, W6, W5, W4, W3, W2, W1] >>> 7)
                                            ;    ^ ([W8, W7, W6, W5, W4, W3, W2, W1] >>> 18)
    VPXOR   Y0, Y0, Y4                      ; Y0 = sigma0([W8, W7, W6, W5, W4, W3, W2, W1])
                                            ;    = ([W8, W7, W6, W5, W4, W3, W2, W1] >>> 7)
                                            ;    ^ ([W8, W7, W6, W5, W4, W3, W2, W1] >>> 18)
                                            ;    ^ ([W8, W7, W6, W5, W4, W3, W2, W1] >> 3)
    ...
    VMOVDQA SHUF, YMMWORD PTR [SHUF_ZZZZ10ZZ]
    ...
    VMOVDQA SHUF, YMMWORD PTR [SHUF_ZZZZZZ32]
    VPSHUFB Y0, X0, SHUF                        ; Y0 = [00, 00, 00, 00, 00, 00, W3, W2]
    VPERM2F128  Y0, Y0, Y0, 08H                     ; Y0 = [00, 00, W3, W2, 00, 00, 00, 00]

    VPSRLD  Y5, Y0, 17                      ; Y5 = [00, 00, W3, W2, 00, 00, 00, 00] >> 17
    VPSLLD  Y6, Y0, 32 - 17                 ; Y6 = [00, 00, W3, W2, 00, 00, 00, 00] << 15
    VPSRLD  Y7, Y0, 19                      ; Y7 = [00, 00, W3, W2, 00, 00, 00, 00] >> 19
    VPSLLD  Y8, Y0, 32 - 19                 ; Y8 = [00, 00, W3, W2, 00, 00, 00, 00] << 13
    VPSRLD  Y9, Y0, 10                      ; Y9 = [00, 00, W3, W2, 00, 00, 00, 00] >> 10
    
    VPOR    Y5, Y5, Y6                      ; Y5 = [00, 00, W3, W2, 00, 00, 00, 00] >>> 17
    VPOR    Y7, Y7, Y8                      ; Y7 = [00, 00, W3, W2, 00, 00, 00, 00] >>> 19
    VPXOR   Y5, Y5, Y7                      ; Y5 = ([00, 00, W3, W2, 00, 00, 00, 00] >>> 17)
                                            ;    ^ ([00, 00, W3, W2, 00, 00, 00, 00] >>> 19)
    VPXOR   Y5, Y5, Y9                      ; Y5 = sigma1([00, 00, W3, W2, 00, 00, 00, 00])
                                            ;    = ([00, 00, W3, W2, 00, 00, 00, 00] >>> 17)
                                            ;    ^ ([00, 00, W3, W2, 00, 00, 00, 00] >>> 19)
                                            ;    ^ ([00, 00, W3, W2, 00, 00, 00, 00] >> 10)
    VPADDD  X0, X0, Y5

    VMOVDQA SHUF, YMMWORD PTR [SHUF_54ZZZZZZ]
    VPSHUFB Y0, X0, SHUF                        ; Y0 = [W5, W4, 00, 00, 00, 00, 00, 00]

    VPSRLD  Y5, Y0, 17                      ; Y5 = [W5, W4, 00, 00, 00, 00, 00, 00] >> 17
    VPSLLD  Y6, Y0, 32 - 17                 ; Y6 = [W5, W4, 00, 00, 00, 00, 00, 00] << 15
    VPSRLD  Y7, Y0, 19                      ; Y7 = [W5, W4, 00, 00, 00, 00, 00, 00] >> 19
    VPSLLD  Y8, Y0, 32 - 19                 ; Y8 = [W5, W4, 00, 00, 00, 00, 00, 00] << 13
    VPSRLD  Y9, Y0, 10                      ; Y9 = [W5, W4, 00, 00, 00, 00, 00, 00] >> 10
    
    VPOR    Y5, Y5, Y6                      ; Y5 = [W5, W4, 00, 00, 00, 00, 00, 00] >>> 17
    VPOR    Y7, Y7, Y8                      ; Y7 = [W5, W4, 00, 00, 00, 00, 00, 00] >>> 19
    VPXOR   Y5, Y5, Y7                      ; Y5 = ([W5, W4, 00, 00, 00, 00, 00, 00] >>> 17)
                                            ;    ^ ([W5, W4, 00, 00, 00, 00, 00, 00] >>> 19)
    VPXOR   Y5, Y5, Y9                      ; Y5 = sigma1([W5, W4, 00, 00, 00, 00, 00, 00])
                                            ;    = ([W5, W4, 00, 00, 00, 00, 00, 00] >>> 17)
                                            ;    ^ ([W5, W4, 00, 00, 00, 00, 00, 00] >>> 19)
                                            ;    ^ ([W5, W4, 00, 00, 00, 00, 00, 00] >> 10)
    VPADDD  X0, X0, Y5

    VMOVDQA SHUF, YMMWORD PTR [SHUF_ZZZZ0ZZZ]
    VPSHUFB Y0, X0, SHUF                        ; Y0 = [00, 00, 00, 00, W0, 00, 00, 00]
    VPERM2F128  Y0, Y0, Y0, 08H                     ; Y0 = [W0, 00, 00, 00, 00, 00, 00, 00]
